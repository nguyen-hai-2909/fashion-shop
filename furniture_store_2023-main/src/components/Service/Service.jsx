import missionUrl from "../../assets/images/mission.svg";
import visionUrl from "../../assets/images/vision.svg";
import historyUrl from "../../assets/images/history.svg";
const Service = () => {
  return (
    <section className=" service-wrap">
      <div className="section-center">
        <article className="header">
          <h3>Style made for you</h3>
          <p>
            We curate contemporary fashion with clean cuts, quality fabrics, and
            pieces you can dress up or down—so every outfit feels effortless and
            true to you.
          </p>
        </article>
        <div className="services-center">
          ...
          <article className="service">
            ...
            <h4>history</h4>
            <p>
              From a small studio focused on fit and fabric to a growing
              community of style-minded shoppers, we have stayed rooted in craft,
              comfort, and the belief that great clothes should feel as good as
              they look.
            </p>
          </article>
        </div>
